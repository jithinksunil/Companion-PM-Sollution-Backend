...
const notificationCollection = mongoose_1.default.model('notification_collection', newSchema); // creating collection using the defined schema and assign to new Model
