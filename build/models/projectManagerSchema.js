...
const projectManagerCollection = mongoose_1.default.model('project_manager_collection', newSchema); // creating collection using the defined schema and assign to new Model
