...
const siteEngineerCollection = mongoose_1.default.model('site_engineer_collection', newSchema); // creating collection using the defined schema and assign to new Model
